...
CPP_SRCS += \
../Via/synthesis/signal_processors/three_axis_scanner.cpp 

OBJS += \
./Via/synthesis/signal_processors/three_axis_scanner.o 

CPP_DEPS += \
./Via/synthesis/signal_processors/three_axis_scanner.d 


# Each subdirectory must supply rules for building sources it contributes
Via/synthesis/signal_processors/%.o: ../Via/synthesis/signal_processors/%.cpp
	@echo 'Building file: $<'
